    ...
    <>
      ...
      <div className="bg-white md:p-4 p-2 rounded-md shadow-lg mb-4">
        ...
        <div className="overflow-auto">
          ...
          <table {...getTableProps()} className={isDarkMode ? "table-dark" : "table-light"}>
            <thead>
          ...
          <div className="text-sm sm:text-base flex justify-between items-center gap-5">
            ...
            <span>
              ...
              <input
                ...
                className={`w-[50px] border-gray-400 border-[1px] border-solid rounded-sm p-[0.1rem_0.3rem] text-[0.8rem] ${isDarkMode ? "text-white bg-gray-700": ""}`}
              />
            </span>
          </div>
